...
Rails.application.config.assets.precompile += %w( timeline/update/timelineUpdate.css )
...
Rails.application.config.assets.precompile += %w( leaderboards/leaderboard.css )
