...
$(function() {
	...
	$friendSearch.autocomplete({
		...
		var listItem = $('<li class="avatar-container"><span class="image-wrap avatar" style="position:relative; display:inline-block; background: #F3F3F3 url(/assets/' + item.avatar_url + ') no-repeat center center; "><img class="avatar" src="/assets/' + item.avatar_url + '" alt="Book icon thumb b34b38fe8a5f330d80e0fb74ba447793970c23457f10e59bbe427b4703ba06ff"></span> ' + item.firstname + '</li>').appendTo(ul);
		return listItem;
	};
});