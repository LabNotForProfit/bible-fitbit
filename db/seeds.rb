...
@passages.collection.each do |passage|
	Question.create({book_id: 1, reference: passage['display'], verse: passage.text, answer: passage['display'].split(':').first.split(' ').last, questionType: "Pick Chapter"})
end
...
@passages.collection.each do |passage|
	Question.create({book_id: 46, reference: passage['display'], verse: passage.text, answer: passage['display'].split(':').first.split(' ').last, questionType: "Pick Chapter"})
end
...
@passages.collection.each do |passage|
	Question.create({book_id: 55, reference: passage['display'], verse: passage.text, answer: passage['display'].split(':').first.split(' ').last, questionType: "Pick Chapter"})
end
...
@passages.collection.each do |passage|
	@question = Question.create({book_id: 47, reference: passage['display'], verse: passage.text, answer: passage['display'].split(':').first.split(' ').last, questionType: "Pick Chapter"})
end
